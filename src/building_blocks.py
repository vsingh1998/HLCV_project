...
from .utils_gl import drop_path
...
class BasicDenseLayer(nn.Module):
    def __init__(self, planes, bn_size):
        ...
        self.add_module('norm1', nn.BatchNorm2d(planes)),
        self.add_module('relu1', nn.ReLU(inplace=True)),
        self.add_module('conv1', nn.Conv2d(planes, bn_size * planes,
                        kernel_size=1, stride=1, bias=False)),
        self.add_module('norm2', nn.BatchNorm2d(bn_size * planes)),
        self.add_module('relu2', nn.ReLU(inplace=True)),
        self.add_module('conv2', nn.Conv2d(bn_size * planes, planes,
                        kernel_size=3, stride=1, padding=1, bias=False)),
